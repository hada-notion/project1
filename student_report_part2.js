function renderSchedulePage() {
  return `
    <div class="sub-page">
      <div class="header-plain"><button class="back-btn-plain" onclick="goIntro()" aria-label="뒤로가기"><svg class="header-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M11 3 2 12l9 9M2 12h20"/></svg></button></div>
      <div class="card">
        <h2>📅 일정정보</h2>
  ...
  return `
    <div class="scroll-container">
      <div class="snap-section intro-section" id="intro-section">
        <button class="hamburger-btn" onclick="openMenu()" aria-label="메뉴 열기"><svg class="header-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M2 5h20M2 12h20M2 19h20"/></svg></button>
      ...
      <div class="snap-section timetable-section" id="timetable-section">
        <button class="hamburger-btn dark" onclick="openMenu()" aria-label="메뉴 열기"><svg class="header-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M2 5h20M2 12h20M2 19h20"/></svg></button>
        <h2>🗓️ 통합 시간표</h2>
    ...
    <div class="reg-detail-page">
      <div class="reg-header-bar">
        <div class="reg-header-top">
          <button class="reg-back-btn" onclick="goIntro()" aria-label="뒤로가기"><svg class="header-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M11 3 2 12l9 9M2 12h20"/></svg></button>
