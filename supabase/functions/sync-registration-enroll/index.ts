...
Deno.serve(async (req: Request) => {
	...
	try {
		...
		// "버튼 실행 실패: 웹훅 요청 시간이 초과되었습니다" 알림이 뜨 수 있으므로(실제로는 꽝까지
		// 정상 처리됨), 응답을 먼저 보내고 나머지는 백그라운드로 미루다. 진행 상황은 등록의
